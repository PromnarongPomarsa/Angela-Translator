...
1. Download [AngelaTranslator-Setup.exe](https://github.com/PromnarongPomarsa/Angela-Translator/releases/download/v2.1.3/AngelaTranslator-Setup.exe) จาก Release
...
# 📥การติดตั้ง
1) ดาวน์โหลดไฟล์ติดตั้งจาก [Download](https://github.com/PromnarongPomarsa/Angela-Translator/releases/download/v2.1.3/AngelaTranslator-Setup.exe) ได้จากตรงนี้
